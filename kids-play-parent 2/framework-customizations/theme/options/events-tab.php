...
$options = array(
	'events-posts' => array(
		'title' => __('Events', 'the-core'),
		'type' => 'tab',
		'options' => array(
			'general-events-box' => array(
				'title' => __('Events Currency', 'the-core'),
				'type' => 'box',
				'options' => array(
					'general_events_options' => array(
						'type' => 'multi',
						'label' => false,
						'attr' => array(
						...
						'inner-options' => array(
							'events_currency_symbol' => array(
								'label' => __('Currency Symbol', 'the-core'),
								'desc' => __('Enter the currency symbol', 'the-core'),
								'type' => 'short-text',
								'value' => '$'
							),
							'events_currency_text' => array(
								'label' => __('Currency Text', 'the-core'),
								'desc' => __('Enter the currency text', 'the-core'),
								'type' => 'short-text',
								'value' => 'USD'
							),
							'events_currency_position' => array(
								'label' => __('Currency Position', 'the-core'),
								'desc' => __('Select the currency position', 'the-core'),
								'value' => 'left',
								'type' => 'switch',
								'right-choice' => array(
									'value' => 'right',
			...
			'header-events-box' => array(
				'title' => __('Single Events Header', 'the-core'),
				'attr'  => array('class' => 'prevent-auto-close'),
				'type'  => 'box',
				'options' => array(
					'general_events_header' => array(
						'type' => 'multi',
						'label' => false,
						'attr' => array(
							'class' => 'fw-option-type-multi-show-borders',
						...
						'inner-options' => array(
							...
							'posts_header_image' => array(
								...
								'help' => __("This default header image will be used for all your events posts if you didn't set one for a specific events post.", "the-core"),
								'type' => 'upload'
							),
							...
							'events_header_title_group' => array(
								'type'    => 'group',
								'options' => array(
									'posts_header_title' => array(
										...
										'picker' => array(
											'posts_title' => array(
												...
												'desc' => __('Select what title will be displayed in the events posts header', 'the-core'),
												'help' => __('This title appears only on the events detail page and will be displayed if you have a header image set (in the events or here)', 'the-core'),
										...
										'choices' => array(
											...
											'custom_title' => array(
												'header_title_typography' => array(
													'attr' => array(
														'data-advanced-for' => 'events_header_title_advanced_styling',
												...
												'custom_title_text' => array(
													'attr' => array('class' => 'events_header_title_advanced_styling'),
												...
												'header_subtitle_typography' => array(
													'attr' => array(
														'data-advanced-for' => 'events_header_subtitle_advanced_styling',
														'class' => 'fw-advanced-button'
													),
													'type' => 'popup',
													'label' => __('Custom Style', 'the-core'),
												...
												'custom_subtitle_text' => array(
													'attr' => array('class' => 'events_header_subtitle_advanced_styling'),
