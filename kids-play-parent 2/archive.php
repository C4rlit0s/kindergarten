		...
		<div class="fw-row">
			...
			<div class="fw-content-area <?php the_core_get_content_class( 'content', $the_core_sidebar_position ); ?>">
				<div class="fw-col-inner">
					...
					<div class="postlist <?php echo the_core_get_blog_view( $the_core_general_posts_options['blog_view'], 'class', $the_core_sidebar_position ); ?>" <?php echo the_core_get_blog_view( $the_core_general_posts_options['blog_view'], 'id', $the_core_sidebar_position ); ?>>
						<?php if ( have_posts() ) :
							$the_core_count = 0;
							...
							while ( have_posts() ) : the_post();
								...
								*/
								...
								get_template_part( 'templates/'.$the_core_general_posts_options['blog_type'].'/content', get_post_format() );
