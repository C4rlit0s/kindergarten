...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( "post clearfix post-list-type-3 $image_alignment" ); ?> itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
