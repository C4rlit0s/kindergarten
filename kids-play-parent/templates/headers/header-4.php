...
?>
<header class="fw-header fw-search-in-menu-area" itemscope="itemscope" itemtype="http://schema.org/WPHeader">
			...
			<div class="fw-container">
				...
				<?php if ( $the_core_header_text != '' ) : ?>
					<div class="fw-info-text-header-main">
						<div class="fw-text"><?php echo do_shortcode($the_core_header_text); ?></div>
					</div>
				<?php endif; ?>
			</div>
		</div>
